...
public class petAppArrayList {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<pat> myPet = new ArrayList<pat>();

        myPet = inputData(myPet,val);
        showdata(myPet);
    }

    private static void showdata(ArrayList<pat> myPet) {
    ...
    private static ArrayList<pat> inputData(ArrayList<pat> myPet, int val) throws IOException {
        BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
